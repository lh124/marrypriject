...
import io.renren.util.SmartInterceptorUrlUtil;
 ...
 */
@Component(value="smartUseraAuthorizationInterceptor")
public class SmartUserAuthorizationInterceptor extends HandlerInterceptorAdapter {
	
	public String LOGIN_URL = "/smart/login.html"; 
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        // 判断不过滤的路径
        if( SmartInterceptorUrlUtil.authCheck(url)) 
    		return true;
