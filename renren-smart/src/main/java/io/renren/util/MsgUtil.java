...
public class MsgUtil {
    ...
    public static SendSmsResponse sendSms(String phone,String randow,String name) throws ClientException {
        //可自助调整超时时间
        ...
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("贵州冠宇科技有限公司");
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_116565141");
