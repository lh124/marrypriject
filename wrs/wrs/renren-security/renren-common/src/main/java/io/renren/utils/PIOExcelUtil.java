...
public class PIOExcelUtil {   
    ...
    public static void main(String[] args) {  
    	try {  
            ...
            eu.setExcelPath("J:\\explorer_download\\chrome\\aa.xls");  
    ...
    public PIOExcelUtil(String excelPath){  
     ...
     * @return 
     */  
    public PIOExcelUtil RestoreSettings(){  
    	PIOExcelUtil instance = new  PIOExcelUtil(this.excelPath);  
        return instance;  
    }  
