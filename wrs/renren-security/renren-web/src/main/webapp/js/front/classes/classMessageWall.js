	...
	//页数 
	  ...
	  domDown : {//上拉
	        ...
	        loadUpFn : function(me){//刷新
	            ...
	            $.ajax({
	                type: 'GET',
	                url:'../photoclassmsgl/list?order=desc&page=' + 1 + '&limit=10&sidx=&classId='+ $('#classId').val(),
	                dataType: 'json',
		           		         ...
		           		         '<div class="weui_cell_hd">'+
		           		          ...
		           		          '<div class="weui_cell_bd" style="width:100%">'+
		           		            '<a class="title" href="javascript:;">'+
		           		              '<span>' + data.page.list[i].nickname + '</span>'+
		           		            '</a>'+
		           		            '<p id="paragraph" class="paragraph">' + data.page.list[i].contents +
		           		            '</p>'+
		           		            /*'<a id="paragraphExtender" class="paragraphExtender">显示全文</a>'+*/
		           		            '<div class="toolbar">'+
		           		              '<p class="timestamp">&nbsp</p>'+
		           		              '<div>'+
		           		            ...
		           		            '</div>'+
		           		            '<p class="liketext"><i class="icon icon-96"></i></p>'+
		           		          '</div>'+
		           		        '</div>'+
		           		      '</div>';
		                    }
	        ...
	        loadDownFn : function(me){//加载更多
	         ...
	         var result = '';
	            $.ajax({
	                type: 'GET',
	                url:'../photoclassmsgl/list?order=desc&page=' + page + '&limit=10&sidx=&classId='+ $('#classId').val(),
	                dataType: 'json',
	                success: function(data){
	           			var arrLen = data.page.list.length;
