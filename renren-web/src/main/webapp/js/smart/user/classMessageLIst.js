	                    ...
	                    if(arrLen > 0){
	                        for(var i = 0; i < arrLen; i++){
		                        //var name = GetLength(data.page.list[i].contents) > 20 ? cutstr(data.page.list[i].contents,20) : data.page.list[i].contents;
		           				...
		           				if( data.page.list[i].voice != null && data.page.list[i].voice != ""){
		           					content = '<audio src="'+data.page.list[i].voice+'" controls="controls"></audio>'+
		           					'<p id="paragraph" class="paragraph">' + data.page.list[i].content +'</p>';
		           				}else{
		           					content = '<p id="paragraph" class="paragraph">' + data.page.list[i].content +'</p>';
		           				}
	                        	...
	                        	var content = "";
		           				...
		           				if( data.page.list[i].voice != null && data.page.list[i].voice != ""){
		           					content = '<audio  controls="controls">'+
		           					          '<source src="'+data.page.list[i].voice+'" id="bgmusic">'
		           					          +'</audio>'+
		           					'<p id="paragraph" class="paragraph">' + data.page.list[i].content +'</p>';
		           				}else{
		           					content = '<p id="paragraph" class="paragraph">' + data.page.list[i].content +'</p>';
