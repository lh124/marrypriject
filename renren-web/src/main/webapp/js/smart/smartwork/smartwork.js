$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [			
			...
			{ label: '作业类型（1为家庭作业，2课堂作业）', name: 'type', index: 'type', width: 80 }, 			
	...
	methods: {
		...
		saveOrUpdate: function (event) {
			...
			$.ajax({
				type: "POST",
			    url: url,
			    data: JSON.stringify(vm.smartWork),
			    success: function(r){
			    	if(r.code === 0){
		...
		getInfo: function(id){
			$.get("../smartwork/info/"+id, function(r){
                vm.smartWork = r.smartWork;
            });
		},
