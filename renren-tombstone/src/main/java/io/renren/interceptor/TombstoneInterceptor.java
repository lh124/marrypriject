...
import io.renren.util.TombstoneInterceptorUrlUtil;
 ...
 */
@Component(value="tombstoneInterceptor")
public class TombstoneInterceptor extends HandlerInterceptorAdapter {
	
	public String LOGIN_URL = "/tombstone/weixin/login.html"; 
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        // 判断不过滤的路径
        if( TombstoneInterceptorUrlUtil.authCheck(url)) 
    		return true;
        
        // 获取登录用户类型
        TombstoneUserEntity frontUser = (TombstoneUserEntity) session.getAttribute(ControllerConstant.SESSION_TOMBSTONE_USER_KEY);;
        if (frontUser == null) {
