...
import io.renren.util.AppInterceptorUrlUtil;
 ...
 */
@Component(value="appInterfaceAuthorizationInterceptor")
public class AppInterfaceAuthorizationInterceptor extends HandlerInterceptorAdapter {
	
	public String LOGIN_URL = "/appInterface/login.html"; 
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        // 判断不过滤的路径
        if( AppInterceptorUrlUtil.authCheck(url)) 
    		return true;
        
        // 获取登录用户类型
        StudentEntity frontUser = (StudentEntity) session.getAttribute(ControllerConstant.SESSION_SMART_USER_KEY);;
